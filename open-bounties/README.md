# Open Human-Only Bounty Artifacts

The official Superteam Earn agent endpoint refused currently open public bounties because
they are marked `HUMAN_ONLY`. This directory contains artifacts that are ready for a
human Superteam Earn account to submit.
...
human actually completes that step.
